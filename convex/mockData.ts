...
/** Seed dates are relative to the moment the seed runs, so a fresh install always opens on a live agenda. */
...
export const INITIAL_EVENTS = [
    { id: 1, title: "Caminhada Solidária", slug: "caminhada-natal", description: "Caminhada solidária para recolha de bens alimentares. Percurso de cerca de 8 km com grau de dificuldade baixo, aberto a toda a família.", date: inDays(13, "09:00"), location: "Ponto de encontro: sede da associação", imageUrl: IMG.walk, categoryId: 3, category: "Desporto", isHighlight: true, createdAt: NOW, updatedAt: NOW, isTournament: false, registrationOpen: true, registrationFields: [{ id: "nome", label: "Nome completo", type: "text", required: true, placeholder: "O seu nome" }, { id: "telefone", label: "Telemóvel", type: "tel", required: true, placeholder: "9xx xxx xxx" }, { id: "acompanhantes", label: "Número de acompanhantes", type: "number", required: false, placeholder: "0" }], status: 'published' },
    { id: 2, title: "Torneio de Sueca", slug: "torneio-sueca-ano-novo", description: "O tradicional torneio de Sueca abre o ano. Reúna a sua dupla e venha disputar os prémios para os três primeiros classificados.", date: inDays(20, "15:00"), location: "Bar da Associação", imageUrl: IMG.cards, categoryId: 6, category: "Lazer", isHighlight: true, createdAt: NOW, updatedAt: NOW, isTournament: true, tournamentType: 'Sueca', registrationOpen: true, maxParticipants: 40, registrationFields: [{ id: "jogador", label: "Nome do jogador", type: "text", required: true }, { id: "parceiro", label: "Nome do parceiro", type: "text", required: true }, { id: "telefone", label: "Telemóvel", type: "tel", required: true }], status: 'published' },
    { id: 3, title: "Torneio de Snooker", slug: "torneio-snooker", description: "Competição aberta na sala de jogos renovada. Inscrições limitadas a 32 jogadores.", date: inDays(48, "20:00"), location: "Sala de Jogos", imageUrl: IMG.snooker, categoryId: 3, category: "Desporto", isHighlight: false, createdAt: NOW, updatedAt: NOW, isTournament: true, tournamentType: 'Snooker', registrationOpen: true, maxParticipants: 32, status: 'published' },
    { id: 4, title: "Workshop: Artesanato Local", slug: "workshop-artesanato", description: "Técnicas tradicionais de tecelagem e cestaria com artesãos da região. Material incluído.", date: inDays(27, "15:00"), location: "Sala de Convívio", imageUrl: IMG.craft, categoryId: 5, category: "Cultura", isHighlight: false, createdAt: NOW, updatedAt: NOW, isTournament: false, registrationOpen: true, status: 'published' },
    { id: 5, title: "Torneio de Malha", slug: "torneio-malha-primavera", description: "Mantendo viva a tradição: o jogo da malha regressa ao recinto exterior num dia de sol, petiscos e boa disposição.", date: inDays(62, "14:00"), location: "Recinto Exterior", imageUrl: IMG.outdoor, categoryId: 5, category: "Cultura", isHighlight: false, createdAt: NOW, updatedAt: NOW, isTournament: true, tournamentType: 'Chinquilho', registrationOpen: true, maxParticipants: 32, status: 'published' },
    { id: 6, title: "Festa Anual da Associação", slug: "festa-verao", description: "A grande festa anual: três dias de música, gastronomia e animação, o ponto alto do ano para a comunidade.", date: inDays(120, "19:00"), location: "Largo da Sede", imageUrl: IMG.festival, categoryId: 2, category: "Eventos", isHighlight: true, createdAt: NOW, updatedAt: NOW, isTournament: false, registrationOpen: false, status: 'published' },
    { id: 7, title: "Torneio de Futsal 24 Horas", slug: "torneio-futsal-24h", description: "Um dos eventos mais vibrantes do ano: 24 horas de futsal no pavilhão, com equipas de toda a região.", date: inDays(90, "10:00"), location: "Pavilhão Gimnodesportivo", imageUrl: IMG.futsal, categoryId: 3, category: "Desporto", isHighlight: true, createdAt: NOW, updatedAt: NOW, isTournament: true, tournamentType: 'Futsal', registrationOpen: true, maxParticipants: 16, registrationFields: [{ id: "equipa", label: "Nome da equipa", type: "text", required: true }, { id: "responsavel", label: "Responsável", type: "text", required: true }, { id: "email", label: "Email de contacto", type: "email", required: true }, { id: "jogadores", label: "Número de jogadores", type: "number", required: true, placeholder: "8" }], status: 'published' },
    { id: 8, title: "Jantar de Convívio", slug: "magusto", description: "Castanhas, jeropiga e água-pé por conta da casa. Recordações do último magusto.", date: inDays(-40, "17:00"), location: "Exterior da Sede", imageUrl: IMG.snooker, categoryId: 2, category: "Eventos", isHighlight: false, createdAt: NOW, updatedAt: NOW, isTournament: false, registrationOpen: false, status: 'published' },
    { id: 9, title: "Aulas de Zumba", slug: "zumba", description: "Aulas semanais para todas as idades. Energia, música e movimento.", date: inDays(3, "19:00"), location: "Sala de Espelhos", imageUrl: IMG.dance, categoryId: 3, category: "Desporto", isHighlight: false, createdAt: NOW, updatedAt: NOW, isTournament: false, registrationOpen: true, status: 'published' },
    { id: 10, title: "Noite de Fados e Petiscos", slug: "noite-fados", description: "Uma noite dedicada à alma portuguesa, com fadistas convidados e o melhor da gastronomia regional.", date: inDays(34, "20:30"), location: "Salão Principal", imageUrl: IMG.fado, categoryId: 5, category: "Cultura", isHighlight: true, createdAt: NOW, updatedAt: NOW, isTournament: false, registrationOpen: true, status: 'published' },
    { id: 11, title: "Torneio Amigável de Petanca", slug: "torneio-petanca", description: "Torneio amigável no campo de jogos da associação, aberto a federados e curiosos, com convívio ao longo do dia.", date: inDays(-12, "09:00"), location: "Campo de Petanca", imageUrl: IMG.outdoor, categoryId: 3, category: "Desporto", isHighlight: true, createdAt: NOW, updatedAt: NOW, isTournament: true, tournamentType: 'Petanca', registrationOpen: true, maxParticipants: 32, status: 'published' },
    { id: 12, title: "Caminhada Mensal", slug: "caminhada-mensal", description: "No primeiro domingo de cada mês, uma caminhada pela natureza da região, antecedida de aquecimento. Aberta a sócios e à população.", date: inDays(6, "08:30"), location: "Partida da sede", imageUrl: IMG.walk, categoryId: 3, category: "Desporto", isHighlight: true, createdAt: NOW, updatedAt: NOW, isTournament: false, registrationOpen: false, status: 'published' },
];
